...
public class ItemPickaxeBase extends ItemPickaxe {
	...
	public ItemPickaxeBase(String imagePath, ToolMaterial toolMaterial, boolean hasOverlay) {
		super(toolMaterial);		
	...
	public void registerIcons(IIconRegister iconRegister) {
		...
		if (hasOverlay) overlay = iconRegister.registerIcon(Reference.MOD_ID + ":tools/overlays/pickaxe_overlay");
	}
}