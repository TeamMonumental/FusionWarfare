...
public class ItemSwordBase extends ItemSword {
	...
	public ItemSwordBase(String imagePath, ToolMaterial toolMaterial, boolean hasOverlay) {
		super(toolMaterial);		
	...
	public void registerIcons(IIconRegister iconRegister) {
		...
		if (hasOverlay) overlay = iconRegister.registerIcon(Reference.MOD_ID + ":tools/overlays/sword_overlay");
	}
}
