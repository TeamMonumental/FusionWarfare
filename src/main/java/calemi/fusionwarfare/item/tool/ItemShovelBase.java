...
public class ItemShovelBase extends ItemSpade {
	...
	public ItemShovelBase(String imagePath, ToolMaterial toolMaterial, boolean hasOverlay) {
		super(toolMaterial);		
	...
	public void registerIcons(IIconRegister iconRegister) {
		...
		if (hasOverlay) overlay = iconRegister.registerIcon(Reference.MOD_ID + ":tools/overlays/shovel_overlay");
	}
}