...
public class ItemRenderFusionShotgun implements IItemRenderer {

	private final ModelFusionShotgun model = new ModelFusionShotgun();
	public final ResourceLocation texture;
	
	public ItemRenderFusionShotgun() {
		texture = new ResourceLocation(Reference.MOD_ID + ":textures/models/fusion_shotgun.png");
	}
	...
	public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
		...
		if (type == IItemRenderer.ItemRenderType.INVENTORY) {
			GL11.glTranslatef(0.8F, 1.8F, 0F);
