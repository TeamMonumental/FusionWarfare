...
public class ModelRocket extends ModelBase {
    ...
    public ModelRocket() {
        ...
        this.fin4.setRotationPoint(-3.8F, 22.5F, -0.5F);
        ...
        this.shaft.setRotationPoint(-5.0F, 21.5F, -0.5F);
        this.shaft.addBox(0.0F, 0.0F, 0.0F, 5, 1, 1, 0.0F);
        this.fin1 = new ModelRenderer(this, 0, 6);
        this.fin1.setRotationPoint(-4.0F, 22.5F, -0.5F);
        ...
        this.fin3.setRotationPoint(-4.0F, 22.5F, -0.5F);
        ...
        this.fin2.setRotationPoint(-4.0F, 21.5F, -0.5F);
        ...
        this.tip.setRotationPoint(6.0F, 21.5F, -0.5F);
