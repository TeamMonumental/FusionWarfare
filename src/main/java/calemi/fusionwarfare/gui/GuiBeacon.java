...
public class GuiBeacon extends GuiContainerBase {
	...
	/*private static final ResourceLocation guiTextures = new ResourceLocation(Reference.MOD_ID + ":textures/gui/fusion_matter_reinforcer.png");
	...
	protected void drawGuiContainerBackgroundLayer(float f, int x, int y) {
        ...
        //Progress Bar
        int i2 = this.tileentity.getCurrentProgressScaled(161);
		this.drawTexturedModalRect(k + 7, l + 86, 0, 181, i2 + 1, 7);
